...
//	}
	...
	/*
	 * public void clickOnPIMTab() { actionDriver.click(pimTab); }
	 * 
	 * //Employee Search public void employeeSearch(String value) {
	 * actionDriver.enterText(employeeSearch, value);
	 * actionDriver.click(searchButton);
	 * actionDriver.scrollToElement(emplFirstAndMiddleName); }
	 * 
	 * //Verify employee first and middle name public boolean
	 * verifyEmployeeFirstAndMiddleName(String emplFirstAndMiddleNameFromDB) {
	 * return actionDriver.compareText(emplFirstAndMiddleName,
	 * emplFirstAndMiddleNameFromDB); }
	 * 
	 * //Verify employee first and middle name public boolean
	 * verifyEmployeeLastName(String emplLastFromDB) { return
	 * actionDriver.compareText(emplLastName, emplLastFromDB); }
	 */
